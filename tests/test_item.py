...
def test_item_create_typical() -> None:
    item = Item.create(
        ...
        datetime=pystac.utils.str_to_datetime("2021-01-02T00:00:00Z"),
        start_datetime=pystac.utils.str_to_datetime("2021-01-01T00:00:00Z"),
        end_datetime=pystac.utils.str_to_datetime("2021-01-03T00:01:00Z"),
        created=pystac.utils.str_to_datetime("2021-01-04T00:00:00Z"),
        updated=pystac.utils.str_to_datetime("2021-01-05T00:00:00Z"),
        title="Some Title",
        ...
        license="Apache-2.0",
        providers=[],
        keywords=["sentinel", "esa", "copernicus"],
        roles=["data"],
        extensions=[
    ...
    assert item.model_dump(mode="json") == {
        ...
        "properties": {
            ...
            "end_datetime": "2021-01-03T00:01:00Z",
            "created": "2021-01-04T00:00:00Z",
            "updated": "2021-01-05T00:00:00Z",
            "title": "Some Title",
            "gsd": 10.0,
            "instruments": [
                "MSI",
